...
from .views import (
    add_to_cart, cart, customer_dashboard, customer_login, customer_orders,
    logout_post, order_detail, place_order, remove_from_cart, resend_otp,
    update_cart, verify_otp,
)
