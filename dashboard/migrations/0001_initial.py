...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ("products", "0004_repair_hover_image_url"),
    ]
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("full_name", models.CharField(max_length=160)), ("phone", models.CharField(max_length=30)),
                ("province", models.CharField(max_length=80)), ("city", models.CharField(max_length=80)), ("address", models.TextField()),
                ("postal_code", models.CharField(blank=True, max_length=20)), ("note", models.TextField(blank=True)),
                ("subtotal", models.PositiveBigIntegerField(default=0)), ("shipping", models.PositiveBigIntegerField(default=0)), ("total", models.PositiveBigIntegerField(default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ("id", models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name="ID")),
                ("product_name", models.CharField(max_length=200)), ("color_name", models.CharField(blank=True, max_length=80)), ("size_name", models.CharField(blank=True, max_length=30)),
                ("unit_price", models.PositiveBigIntegerField()), ("quantity", models.PositiveIntegerField(default=1)),
                ("color", models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to="products.color")),
        ...
        migrations.AddConstraint(
            model_name="cartitem",
            constraint=models.UniqueConstraint(fields=("user", "product", "color", "size"), name="unique_user_cart_line"),
        ),
    ]
